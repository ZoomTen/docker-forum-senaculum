...
if(isset($_POST['forumID'])) {
	...
	$permission->editMemberPermissions($forumID, $memberID, $view, $read, $thread, $post, $edit, $delete, $sticky, $announce, $vote, $poll, $attach, $moderator);
	
	if(isset($_POST['default'])) {
		$permission->removeMemberPermission($memberID,$_POST['default']);
	}
...
<html>
	<head>
		<title>
			<?php echo $lang['memberPermissions']; ?>
		</title>
		<script type="text/javascript">
			top.location.href = "memberPermissions.php?done=1";
		</script>
	</head>
	<body>
...
$memberPermissions = $permission->getAllMemberPermissionsUnsetSet($memberID);	
...
<html>
	...
	<body style="margin:0px; padding:0px;">
		...
		?>
		<form action="editMemberPermissions.php?id=<?php echo $_GET['id']; ?>" id="memberPermissions" method="post">
			<table width="905" cellpadding="2" cellspacing="0">
			<?php
			foreach($memberPermissions as $currentPermission) {
